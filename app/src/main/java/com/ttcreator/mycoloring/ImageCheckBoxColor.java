...
import com.ttcreator.mycoloring.utill.DensityUtil;

public class ImageCheckBoxColor extends LinearLayout implements Checkable, View.OnClickListener {
    ...
    public ImageCheckBoxColor(Context context, AttributeSet attrs) {
        super(context, attrs);
